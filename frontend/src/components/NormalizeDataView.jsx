...
const NormalizeDataView = ({
    ...
    // Create normalized telemetry ref that divides ECU_Temp and Throttle by 10
        ...
        <section className="card">
            ...
            <div className="channel-picker">
                <p className="picker-title">
                    Normalize Data - Display channels ({selectedChannels.length}) — IMU/RPM channels auto-group in one window
                </p>
                ...
                <div className="plot-grid">
                    {plotGroups.map((group, index) => (
                        <div className="plot-card" key={group.groupKey}>
                            <UplotPanel
                                telemetryRef={normalizedTelemetryRef}
...
export default NormalizeDataView;
